...
\centering
\fbox{
\includegraphics[scale=0.25]{WebAppsBackendSystemDiagram.png}
}
\caption{\label{fig:trello} Backend System Design}
\end{figure}

Routing, Models, Templates front end, REST
