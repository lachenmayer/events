...
The Union calendar does not expose the data in a machine readable format, so it was necessary to scrape the events directly from the HTML that the website provides.
